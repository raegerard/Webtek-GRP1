...
--
-- Host: localhost
-- Generation Time: May 23, 2015 at 06:14 AM
...
--
-- Table structure for table `addedsubject`
--

CREATE TABLE IF NOT EXISTS `addedsubject` (
  `classCode` int(50) NOT NULL,
  ...
  `currentSlot` int(50) NOT NULL,
  `maxSlot` int(50) NOT NULL DEFAULT '50',
  PRIMARY KEY (`classCode`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `addedsubject`
--

INSERT INTO `addedsubject` (`classCode`, `CourseNo`, `courseDescription`, `units`, `time`, `days`, `room`, `currentSlot`, `maxSlot`) VALUES
(1234, '1234', '1234', 123, '123', '123', '123', 0, 50);
...
CREATE TABLE IF NOT EXISTS `firstyear` (
  ...
  `currentSlots` int(20) NOT NULL,
  `maxSlots` int(20) DEFAULT '50'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `firstyear` (`classCode`, `courseNumber`, `courseDescription`, `units`, `time`, `days`, `room`, `courseName`, `block`, `year`, `currentSlots`, `maxSlots`) VALUES
(9603, 'IT 121', 'IT Fundamentals 1', 2, '1:00-2:00', 'WS', 'S524', 'BSIT', 1, 1, 0, 50),
(9602, 'IT 311', 'Database management', 2, '4:00-5:00', 'WS', 'S423', 'BSIT', 2, 1, 0, 50),
(9601, 'IT 111', 'Programming Fundamentals', 2, '8:30-9:30', 'MTH', 'S523', 'BSIT', 1, 1, 0, 50),
(9600, 'IT 111', 'Programming Fundamentals', 2, '9:30-10:30', 'MTH', 'S523', 'BSIT', 2, 1, 0, 50),
(1111, 'ENGL1', 'Communication arts 1', 3, '8:30-9:30', 'MWF', 'P333', 'SABM', 1, 1, 0, 50),
(1112, 'ENGL1', 'Communication arts 1', 3, '10:30-11:30', 'TTHS', 'P600', 'SABM', 2, 1, 0, 50),
(1121, 'ENGL 5', 'Phonetics and oral english', 3, '1:00-2:00', 'TTHS', 'P700', 'SABM', 1, 1, 0, 50),
(1122, 'ENGL 5', 'Phonetics and oral english', 3, '3:00-4:00', 'MWF', 'p400', 'SABM', 2, 1, 0, 50);
...
CREATE TABLE IF NOT EXISTS `schedule` (
  ...
  `days` varchar(50) NOT NULL,
  `room` varchar(50) NOT NULL,
  `currentSlots` int(50) NOT NULL AUTO_INCREMENT,
  `maxSlots` int(50) NOT NULL,
  PRIMARY KEY (`classCode`),
  KEY `currentSlots` (`currentSlots`)
